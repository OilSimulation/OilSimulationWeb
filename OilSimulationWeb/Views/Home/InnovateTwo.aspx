            ...
            <div style="margin-right: 415px;box-shadow: 0px 1px 3px rgba(0, 0, 0, 0.1);">
                ...
                <div class="imgpic">
                    <ul> 
                       <li>
                           <div class="pro-pic">
                                <a href="javascript:void(0);" onclick="LoadUrl('/Innovate/InnModeThree');"><img src="<%=Url.Content("~/Images/气藏.png")%>"></a>
                           </div>
                           <p>
                                <a href="javascript:void(0);" onclick="LoadUrl('/Innovate/InnModeThree');">均质气藏开发方案设计与开发效果预测实践</a>
                           </p>
                       </li> 
                       <li>
                           <div class="pro-pic">
                                <a href="javascript:void(0);" onclick="LoadUrl('/Innovate/InnModeFour');"><img src="<%=Url.Content("~/Images/气藏.png")%>"></a>
                           </div>
                           <p>
                                <a href="javascript:void(0);" onclick="LoadUrl('/Innovate/InnModeFour');">实际气藏开发方案设计与开发效果预测实践</a>
                           </p>
                       </li>  
                    </ul>
                </div>
            ...
            <div style="padding: 10px 20px 20px 0px;position: relative;">
                ...
                <div class="g-sd2">
                    <div id="j-courseImg" class="m-recimg canlick">
                        ...
                        <a  onclick="LoadExam(10);" class="f-db clickBtn"></a>
                    </div>
                </div> 
            </div> 
            <div style="padding: 10px 20px 20px 0px;"> 
                <div class="t-title f-f0">规格型号：CB-SIM32</div> 
            </div>
        </div>
    </div>  
</asp:Content>
